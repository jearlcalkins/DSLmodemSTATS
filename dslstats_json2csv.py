...
input_json_file = 'json_c1100t.txt' 
output_csv_file = 'out.csv' 
parser = argparse.ArgumentParser()
parser.add_argument('-i', default=input_json_file, help="input file")
parser.add_argument('-o', default=output_csv_file, help="output file")
args = parser.parse_args()
input_json_file = args.i
output_csv_file = args.o


with open (input_json_file, "r") as fh, open(output_csv_file, "w", newline="") as fcsv:
